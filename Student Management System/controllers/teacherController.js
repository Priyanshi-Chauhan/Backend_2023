...
const teacher_verification_get = (req, res) => {
    res.render("teacher/login",{
        error: ""
    });
};

const teacher_verification_post = (req, res) => {
...
const teacher_add_post = async (req, res) => {
    ...
    try {
        const newStudent = await current.save();
...
module.exports = {
    teacher_verification_get,
    teacher_verification_post,
    teacher_viewall_get,
    teacher_edit_get,
    teacher_edit_post,
    teacher_delete_get,
